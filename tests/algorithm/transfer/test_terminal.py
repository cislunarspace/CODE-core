...
def dummy_orbit(earth_moon_system):
    # DRO 种子初值（同 tests/algorithm/conftest.py）：稳定周期轨道，远离月球，
    # CR3BP 积分到任意相位都不发散。测试只用首点与 period，故 50 点填同值即可。
    state0 = np.array([0.79188556619742, 0.0, 0.0, 0.0, 0.536819842572739, 0.0])
    period = 3.472535773770595
    n = 50
